      ...
      <div class="row">
        <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
          <div>
            ...
            <a href="login.php" class="download-btn"><i class="bx bx-cube-alt"></i>Log in</a>
            <a href="register.php" class="download-btn"><i class="bx bx-atom"></i> Register</a>
          </div>
        </div>
    ...
    <section id="features" class="features">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Advantages</h2>
          <p>Some advantages you will get when you registered your website in NeedSSL, #Becauseyouneedit</p>
        </div>
            ...
            <div class="content d-flex flex-column justify-content-center">
              <div class="row">
                <div class="col-md-6 icon-box" data-aos="fade-up">
                  ...
                  <p>Get full protection for any domain, website and backend system in under 5 minutes by using NeedSSL, the easiest way to issue free SSL certificates.</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                  <i class="bx bx-cube-alt"></i>
                  <h4>Quick Validation</h4>
                  <p>Get new and existing SSL certificates approved within a matter of seconds using one-step email validation, server uploads or CNAME verification.</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
                  <i class="bx bx-images"></i>
                  <h4>ACME Integrations</h4>
                  <p>Partnering with some of the biggest ACME providers, NeedSSL allows you to manage and renew existing certificates without ever lifting a finger.</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="300">
                  <i class="bx bx-shield"></i>
                  <h4>SSL Rest API</h4>
                  <p>Save time and money by automating SSL certificate management using the NeedSSL REST API, supporting certificate issuance, CSR validation, and more.</p>
                </div>
                ...
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="500">
                  ...
                  <p>Away, away, from men and towns, To the wild wood and the downs, To the silent wilderness, Where the soul need not repress its music</p>
                </div>
              </div>
            </div>
          </div>
